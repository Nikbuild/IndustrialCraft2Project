...
/**
 * MFSU Screen - Renders the GUI for the MFSU energy storage
 *
 * GUI Features:
 * - Energy bar showing current storage level
 * - 2 slots for charging/discharging items
 * - Uses same layout as BatBox/MFE (GUIElectricBlock.png style)
 */
public class MFSUScreen extends AbstractContainerScreen<MFSUMenu> {

    private static final ResourceLocation TEX_BG =
            ResourceLocation.fromNamespaceAndPath(IndustrialCraft.MODID, "textures/gui/mfsu.png");

    private static final ResourceLocation TEX_ENERGY =
            ResourceLocation.fromNamespaceAndPath(IndustrialCraft.MODID, "textures/gui/mfsu_energy.png");
    ...
    public MFSUScreen(MFSUMenu menu, Inventory playerInv, Component title) {
