...
public class MaceratorScreen extends AbstractContainerScreen<MaceratorMenu> {
    ...
    private static final ResourceLocation TEX_BG =
        ResourceLocation.fromNamespaceAndPath(IndustrialCraft.MODID, "textures/gui/macerator.png");
    private static final ResourceLocation TEX_ARROW =
        ResourceLocation.fromNamespaceAndPath(IndustrialCraft.MODID, "textures/gui/macerator_arrow.png");
    private static final ResourceLocation TEX_ENERGY =
        ResourceLocation.fromNamespaceAndPath(IndustrialCraft.MODID, "textures/gui/macerator_energy.png");
    ...
    public MaceratorScreen(MaceratorMenu menu, Inventory playerInv, Component component) {
    ...
    /**
     * Render progress arrow overlay (reveals left-to-right based on macerating progress).
     */
    private void renderProgressArrow(GuiGraphics guiGraphics) {
        ...
        // Macerator arrow is 24x16 pixels
        int maxWidth = 24;
