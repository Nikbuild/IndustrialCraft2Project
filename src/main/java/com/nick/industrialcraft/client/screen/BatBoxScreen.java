...
/**
 * BatBox Screen - Renders the GUI for the BatBox energy storage
 *
 * GUI Features:
 * - Energy bar showing current storage level
 * - 2 slots for charging/discharging items
 * - (Text display for power level will be added later)
 */
public class BatBoxScreen extends AbstractContainerScreen<BatBoxMenu> {

    private static final ResourceLocation TEX_BG =
            ResourceLocation.fromNamespaceAndPath(IndustrialCraft.MODID, "textures/gui/batbox.png");

    private static final ResourceLocation TEX_ENERGY =
            ResourceLocation.fromNamespaceAndPath(IndustrialCraft.MODID, "textures/gui/batbox_energy.png");
    ...
    public BatBoxScreen(BatBoxMenu menu, Inventory playerInv, Component title) {
    ...
    protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
        ...
        // TODO: Add power level text display later
        // "Power Level:"
        // "X / 40000"
        // "Out: 32 EU/t"
    }
