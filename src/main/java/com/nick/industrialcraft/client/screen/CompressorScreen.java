...
public class CompressorScreen extends AbstractContainerScreen<CompressorMenu> {
    ...
    private static final ResourceLocation TEX_BG =
        ResourceLocation.fromNamespaceAndPath(IndustrialCraft.MODID, "textures/gui/compressor.png");
    private static final ResourceLocation TEX_ARROW =
        ResourceLocation.fromNamespaceAndPath(IndustrialCraft.MODID, "textures/gui/compressor_arrow.png");
    private static final ResourceLocation TEX_ENERGY =
        ResourceLocation.fromNamespaceAndPath(IndustrialCraft.MODID, "textures/gui/compressor_energy.png");
    ...
    public CompressorScreen(CompressorMenu menu, Inventory playerInv, Component component) {
    ...
    /**
     * Render progress arrow overlay (reveals left-to-right based on compressing progress).
     */
    private void renderProgressArrow(GuiGraphics guiGraphics) {
        ...
        // Compressor arrow is 24x16 pixels (same as macerator)
        int maxWidth = 24;
